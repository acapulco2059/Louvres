 ...
 */
final class Version20200115133636 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE country ADD nom_en_gb VARCHAR(45) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, ADD nom_fr_fr VARCHAR(45) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, DROP name_en_gb, DROP name_fr_fr, CHANGE id id SMALLINT UNSIGNED AUTO_INCREMENT NOT NULL, CHANGE alpha2 alpha2 VARCHAR(2) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, CHANGE alpha3 alpha3 VARCHAR(3) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`');
